...
\teaser{
  ...
  \centering
   \caption{We introduce silhouette constraints to improve the quality of unconstrained 3D face reconstruction. Here, we show a comparison between the state of the art approach by Roth et al. \cite{Roth:2015:UFR} and our technique. Note how our approach follows more faithfully the silhouettes of the input images, especially around the nose region.}
 \label{fig:teaser}
}
